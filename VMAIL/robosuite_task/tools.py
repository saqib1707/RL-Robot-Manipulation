...
def count_episodes(directory):
    """
        Counts number of '*.npz' files in a given directory.
        Each expert demonstration filename has episode_length. It 
        sums the total number of steps. 
    """
